...
#
# Script generated by Vivado on Sun Sep 08 18:14:52 PDT 2024
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jay/SJSU_EE_Masters/Classes/EE-275-Advanced-Computer-Arch/RISC/RISC.cache/compile_simlib/modelsim"
  fi
